...
export default function PendingMembersCard({
    ...
    async function rejectMember(userId) {
        try {
            ...
            alert('Permintaan member berhasil ditolak.');
                        ...
                        >
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="rounded-lg bg-green-600 hover:bg-green-700 px-4 py-2 disabled:opacity-60"
                                >
                                    {loadingId === member.id ? (
                                ...
                                <button
                                    ...
                                    className="rounded-lg bg-red-600 hover:bg-red-700 px-4 py-2 disabled:opacity-60"
                                >
                                    {loadingId === member.id ? (
                                        <Loader2 className="w-4 h-4 animate-spin" />
                                    ) : (
